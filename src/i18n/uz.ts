...
export const uz: Dictionary = {
  ...
  Sat: 'Shan',
  Sun: 'Yak',
  'No schedules yet': 'Hali jadval yo\u2019q',
  'Set one and focus starts on its own, without you having to remember.':
    'Bittasini qo\u2019ying \u2014 fokus siz eslamasangiz ham o\u2019zi boshlanadi.',
  'Blocks the {n} apps on your list.': 'Ro\u2019yxatingizdagi {n} ilovani bloklaydi.',
  'Choose apps first — a schedule blocks your saved list.':
    'Avval ilovalarni tanlang \u2014 jadval saqlangan ro\u2019yxatni bloklaydi.',
  'Start it as a strict session': 'Qat\u2019iy sessiya sifatida boshlansin',
  'Pick at least one day': 'Kamida bitta kun tanlang',
  'A schedule with no days never runs.': 'Kunsiz jadval hech qachon ishlamaydi.',
  'Delete this schedule?': 'Bu jadval o\u2019chirilsinmi?',
  'It will stop starting sessions on its own.':
    'U endi o\u2019zi sessiya boshlamaydi.',
